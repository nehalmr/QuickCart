...
def lowerframe(newFrame) :
        ...
        #profile button
        home = CTkButton(master=lowerFrame, fg_color="#b303d0", text="Home", width=20, height=40, corner_radius=100, command=lambda: open_home_screen(lowerFrame, newFrame))
        # profile.place(relx=0, rely=0 padx=5, pady=5)
