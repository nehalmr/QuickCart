...
def createCosmeticTemplate(currentFrame, newFrame, email) :
...
def leftFrame(newFrame) :
        ...
        label_baby_product = ctk.CTkLabel(master=frame1, text="Cosmetics Product", fg_color="#f5c2fe", text_color="#601E88",  font=("Arial Bold", 24))
        ...
        C1 = ctk.CTkButton(master=pf1, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C1', newFrame))
        C1.image = Image
        C1.pack()
        ...
        #Added Image
        image_path = "assets/C2.jpg"
        image = Image.open(image_path)
        photo = ImageTk.PhotoImage(image)
        C2 = ctk.CTkButton(master=pf2, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C2', newFrame))
        C2.image = Image
        C2.pack()
        ...
        #Added Image
        image_path = "assets/C3.jpg"
        image = Image.open(image_path)
        photo = ImageTk.PhotoImage(image)
        C3 = ctk.CTkButton(master=pf3, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C3', newFrame))
        C3.image = Image
        C3.pack()
        ...
        #Added Image
        image_path = "assets/C4.jpg"
        image = Image.open(image_path)
        photo = ImageTk.PhotoImage(image)
        C4 = ctk.CTkButton(master=pf4, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C4', newFrame))
        C4.image = Image
        C4.pack()
        ...
        #Added Image
        image_path = "assets/C5.jpg"
        image = Image.open(image_path)
        photo = ImageTk.PhotoImage(image)
        C5 = ctk.CTkButton(master=pf5, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C5', newFrame))
        C5.image = Image
        C5.pack()
        ...
        #Added Image
        image_path = "assets/C6.jpg"
        image = Image.open(image_path)
        photo = ImageTk.PhotoImage(image)
        C6 = ctk.CTkButton(master=pf6, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C6', newFrame))
        C6.image = Image
        C6.pack()
        ...
        #Added Image
        image_path = "assets/C7.jpg"
        image = Image.open(image_path)
        photo = ImageTk.PhotoImage(image)
        C7 = ctk.CTkButton(master=pf7, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C7', newFrame))
        C7.image = Image
        C7.pack()
        ...
        #Added Image
        image_path = "assets/C8.jpg"
        image = Image.open(image_path)
        photo = ImageTk.PhotoImage(image)
        C8 = ctk.CTkButton(master=pf8, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C8', newFrame))
        C8.image = Image
        C8.pack()
        ...
        #Added Image
        image_path = "assets/C9.jpg"
        image = Image.open(image_path)
        photo = ImageTk.PhotoImage(image)
        C9 = ctk.CTkButton(master=pf9, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C9', newFrame))
        C9.image = Image
        C9.pack()
        ...
        #Added Image
        image_path = "assets/C10.jpg"
        image = Image.open(image_path)
        photo = ImageTk.PhotoImage(image)
        C10 = ctk.CTkButton(master=pf10, image=photo, text="", height=5, width=5, corner_radius=5, command=lambda: showData('C10', newFrame))
        C10.image = Image
        C10.pack()
